 ...
 * `true` has the same effect as setting each `ion-content style="background-image: url(../img/sfondofacolta.jpg); background-repeat:no-repeat; background-size: cover;"` to have `overflow-scroll='false'`.
 ...
 *     </ion-header-bar>
 *     <ion-content style="background-image: url(../img/sfondofacolta.jpg); background-repeat:no-repeat; background-size: cover;">
 *       Hello!
 *     </ion-content style="background-image: url(../img/sfondofacolta.jpg); background-repeat:no-repeat; background-size: cover;">
 *   </ion-modal-view>
 * </script>
 ...
 *
 *   // .fromTemplate() method
 *   var template = '<ion-popover-view><ion-header-bar> <h1 class="title">My Popover Title</h1> </ion-header-bar> <ion-content style="background-image: url(../img/sfondofacolta.jpg); background-repeat:no-repeat; background-size: cover;"> Hello! </ion-content style="background-image: url(../img/sfondofacolta.jpg); background-repeat:no-repeat; background-size: cover;"></ion-popover-view>';
 *
...
function($ionicTemplateLoader, $ionicBackdrop, $q, $timeout, $rootScope, $ionicBody, $compile, $ionicPlatform, $ionicModal, IONIC_BACK_PRIORITY) {
  ...
  var $ionicPopup = {
     ...
     *   okType: '', // String (default: 'button-dark'). The type of the OK button.
     * }
     * ```
     *
 ...
 * ```html
 * <body ng-controller="MainCtrl">
 *   <ion-content style="background-image: url(../img/sfondofacolta.jpg); background-repeat:no-repeat; background-size: cover;" delegate-handle="mainScroll">
 ...
 * ```html
 * {% raw %}
 * <ion-content style="background-image: url(../img/sfondofacolta.jpg); background-repeat:no-repeat; background-size: cover;" ng-controller="MyCtrl">
  ...
  function($scope, $attrs, $element, $ionicBind, $timeout) {
    ...
    self.init = function() {
      ...
      if (!scrollParent || !scrollParent.classList.contains('ionic-scroll') ||
        ...
        throw new Error('Refresher must be immediate child of ion-content style="background-image: url(../img/sfondofacolta.jpg); background-repeat:no-repeat; background-size: cover;" or ion-scroll');
      }
 ...
 * directive.
 *
 * If there is any dynamic content inside the ion-content style="background-image: url(../img/sfondofacolta.jpg); background-repeat:no-repeat; background-size: cover;", be sure to call `.resize()` with {@link ionic.service:$ionicScrollDelegate}
 ...
 *   </div>
 * </ion-header-bar>
 * <ion-content style="background-image: url(../img/sfondofacolta.jpg); background-repeat:no-repeat; background-size: cover;" class="has-header">
 *   Some content!
 * </ion-content style="background-image: url(../img/sfondofacolta.jpg); background-repeat:no-repeat; background-size: cover;">
 * ```
 */
 ...
 * @usage
 * ```html
 * <ion-content style="background-image: url(../img/sfondofacolta.jpg); background-repeat:no-repeat; background-size: cover;" class="has-footer">
 *   Some content!
 * </ion-content style="background-image: url(../img/sfondofacolta.jpg); background-repeat:no-repeat; background-size: cover;">
 ...
 * @usage
 * ```html
 * <ion-content style="background-image: url(../img/sfondofacolta.jpg); background-repeat:no-repeat; background-size: cover;" ng-controller="MyController">
 *   <ion-list>
 *   ....
 *   ....
 *   </ion-list>
...
*   <ion-item>
*     I love kittens!
*     <ion-option-button class="button-dark">Share</ion-option-button>
 ...
 *   <ion-nav-view>
 *     <ion-view>
 *       <ion-content style="background-image: url(../img/sfondofacolta.jpg); background-repeat:no-repeat; background-size: cover;">Hello!</ion-content style="background-image: url(../img/sfondofacolta.jpg); background-repeat:no-repeat; background-size: cover;">
 *     </ion-view>
 *   </ion-nav-view>
 * </body>
 * ```
 ...
 *     <ion-content style="background-image: url(../img/sfondofacolta.jpg); background-repeat:no-repeat; background-size: cover;" ng-controller="HomeCtrl">
 ...
 * @usage
 * ```html
 * <ion-content style="background-image: url(../img/sfondofacolta.jpg); background-repeat:no-repeat; background-size: cover;" scroll="false">
 ...
 * individual tabs.
 *
 * Note: do not place ion-tabs inside of an ion-content style="background-image: url(../img/sfondofacolta.jpg); background-repeat:no-repeat; background-size: cover;" element; it has been known to cause a
 * certain CSS bug.
 *
 * @usage
 * ```html
