    ...
    start: function(e) {
      ...
      ionic.requestAnimationFrame(function() {
        ...
        for (var x = 0; x < 6; x++) {
          ...
          if (ele.tagName == 'ion-content style="background-image: url(../img/sfondofacolta.jpg); background-repeat:no-repeat; background-size: cover;"' || (ele.classList && ele.classList.contains('pane')) || ele.tagName == 'BODY') {
            break;
          }
...
ionic.views.Scroll = ionic.views.View.inherit({
  ...
  */
  ...
  __initEventHandlers: function() {
    ...
    // input and returning to a previously resized scroll view in an ion-content style="background-image: url(../img/sfondofacolta.jpg); background-repeat:no-repeat; background-size: cover;".
